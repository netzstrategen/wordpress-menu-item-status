    ...
    $form_item .= '
          <p class="field-checkbox description description-thin">
            <label for="edit-menu-item-link-status' . $item_id . '">
              ...
              <input type="checkbox" id="edit-menu-item-link-status-' . $item_id . '" class="edit-menu-item-link-status" name="menu-item-link-status[' . $item_id . ']" value="0"' . checked($link_status, 0, FALSE) . ' />
