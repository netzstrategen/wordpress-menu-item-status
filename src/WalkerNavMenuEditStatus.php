...
/**
 * @file
 * Contains \Netzstrategen\MenuItemStatus\Custom_Walker_Nav_Menu_Edit.
 */
      ...
      <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
        ...
        <p class="field-checkbox description description-wide">
          <label for="edit-menu-item-status-<?= $item_id; ?>">
            <input type="checkbox" id="edit-menu-item-status-<?= $item_id; ?>" class="edit-menu-item-status" name="menu-item-status[<?= $item_id; ?>]"<?= get_post_meta($item_id, '_menu_item_status', TRUE);?> value='Yes' />
            <?php _e('Hidden'); ?>
          </label>
        </p>
